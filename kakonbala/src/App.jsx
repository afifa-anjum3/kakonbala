...
const C = {
  ...
  success: "#2E7D32",
  successBg: "rgba(232,245,233,0.85)",
  warn: "#E65100",
  warnBg: "rgba(255,243,224,0.85)",
  danger: "#C62828",
  dangerBg: "rgba(255,235,238,0.85)",
  info: "#1565C0",
  infoBg: "rgba(227,242,253,0.85)",
};
...
const T = {
  ...
  bn: {
    ...
    photoHint: "JPG, PNG — সর্বোচ্চ ৫MB",
...
const catBadge = (cat) => ({
  ...
  color:
    cat === "jewelry" ? "#AD1457" : cat === "crafts" ? "#6A1B9A" : "#4527A0",
  backdropFilter: BLUR,
});
const statusBadge = (s) => ({
  display: "inline-block",
...
const metCard = (c) => ({
  ...glassCard,
  padding: "16px 20px",
  borderLeft: `4px solid ${c || C.primary}`,
});
    ...
    >
      ...
      <img
        ...
        style={{
          width: "100%",
          height: "100%",
          objectFit: zoom ? "contain" : "contain",
          padding: 4,
...
const ADMIN_EMAIL = "kakonbehroj@gmail.com";
...
export default function App() {
  ...
  const visible = products.filter((p) => {
    ...
    if (catFilter === "clothing") {
      if (clothingGroup !== "all" && p.clothingGroup !== clothingGroup)
        return false;
    }
  ...
  function addToCart(product, opts = {}) {
    ...
    const optStr = [opts.size, opts.color, opts.piece]
      .filter(Boolean)
      .join(" · ");
    notify(
  ...
  async function saveEdit() {
    if (!editProduct.name || !editProduct.price || !editProduct.stock)
      return notify("⚠ Fill all required fields");
    const eValidUrls = (editProduct.imageUrls || [editProduct.imageUrl]).filter(
      Boolean,
    );
  ...
  async function handleCheckout() {
    ...
    try {
      ...
      if (data.url) {
        ...
        notify("⚠ Payment error: " + (data.error || "unknown"));
        setPayLoading(false);
      }
    } catch (err) {
      notify("⚠ " + err.message);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <img
            ...
            style={{
              ...
              height: 50,
              borderRadius: "50%",
              border: "2px solid rgba(173,20,87,0.4)",
              objectFit: "cover",
            }}
          />
          <div>
          ...
          {(isAdmin
            ...
            <button
              ...
              style={{
                ...
                border:
                  tab === key ? "none" : "1px solid rgba(255,255,255,0.5)",
                padding: "7px 14px",
                borderRadius: 20,
                cursor: "pointer",
                fontSize: 12,
      ...
      >
              ...
              {catFilter === "jewelry" && (
                ...
                >
                  <button
                    ...
                    style={{
                      background:
                        subFilter === "all" ? "rgba(173,20,87,0.15)" : GLASS2,
                      color: subFilter === "all" ? C.primary : C.med,
                      border: `1px solid ${subFilter === "all" ? "rgba(173,20,87,0.4)" : "rgba(255,255,255,0.5)"}`,
                      padding: "4px 14px",
                      borderRadius: 15,
                      cursor: "pointer",
                      fontSize: 12,
                  ...
                  {CATS.jewelry.subs.map((s) => (
                    <button
                      ...
                      style={{
                        background:
                          subFilter === s ? "rgba(173,20,87,0.15)" : GLASS2,
                        color: subFilter === s ? C.primary : C.med,
                        border: `1px solid ${subFilter === s ? "rgba(173,20,87,0.4)" : "rgba(255,255,255,0.5)"}`,
                        padding: "4px 14px",
                        borderRadius: 15,
                        cursor: "pointer",
                        fontSize: 12,
              ...
              {catFilter === "crafts" && (
                ...
                >
                  <button
                    ...
                    style={{
                      background:
                        subFilter === "all" ? "rgba(106,27,154,0.15)" : GLASS2,
                      color: subFilter === "all" ? C.purple : C.med,
                      border: `1px solid ${subFilter === "all" ? "rgba(106,27,154,0.4)" : "rgba(255,255,255,0.5)"}`,
                      padding: "4px 14px",
                      borderRadius: 15,
                      cursor: "pointer",
                      fontSize: 12,
                  ...
                  {CATS.crafts.subs.map((s) => (
                    <button
                      ...
                      style={{
                        background:
                          subFilter === s ? "rgba(106,27,154,0.15)" : GLASS2,
                        color: subFilter === s ? C.purple : C.med,
                        border: `1px solid ${subFilter === s ? "rgba(106,27,154,0.4)" : "rgba(255,255,255,0.5)"}`,
                        padding: "4px 14px",
                        borderRadius: 15,
                        cursor: "pointer",
                        fontSize: 12,
                      ...
                      style={{
                        background:
                          clothingGroup === "all"
                            ? "rgba(249,168,37,0.2)"
                            : GLASS2,
                        color: clothingGroup === "all" ? "#B8860B" : C.med,
                        border: `1px solid ${clothingGroup === "all" ? "rgba(249,168,37,0.5)" : "rgba(255,255,255,0.5)"}`,
                        padding: "4px 14px",
                        borderRadius: 15,
                        cursor: "pointer",
                        fontSize: 12,
                        ...
                        style={{
                          background:
                            clothingGroup === g
                              ? "rgba(249,168,37,0.2)"
                              : GLASS2,
                          color: clothingGroup === g ? "#B8860B" : C.med,
                          border: `1px solid ${clothingGroup === g ? "rgba(249,168,37,0.5)" : "rgba(255,255,255,0.5)"}`,
                          padding: "4px 14px",
                          borderRadius: 15,
                          cursor: "pointer",
                          fontSize: 12,
                        ...
                        style={{
                          background:
                            subFilter === "all"
                              ...
                              : GLASS2,
                          color: subFilter === "all" ? "#B8860B" : C.med,
                          border: `1px solid ${subFilter === "all" ? "rgba(249,168,37,0.4)" : "rgba(255,255,255,0.4)"}`,
                          padding: "3px 12px",
                          borderRadius: 12,
                          cursor: "pointer",
                          fontSize: 11,
                          ...
                          style={{
                            background:
                              subFilter === s
                                ? "rgba(249,168,37,0.15)"
                                : GLASS2,
                            color: subFilter === s ? "#B8860B" : C.med,
                            border: `1px solid ${subFilter === s ? "rgba(249,168,37,0.4)" : "rgba(255,255,255,0.4)"}`,
                            padding: "3px 12px",
                            borderRadius: 12,
                            cursor: "pointer",
                            fontSize: 11,
              ...
              <div style={{ ...glassCard, padding: 20 }}>
                ...
                <ResponsiveContainer width="100%" height={200}>
                  ...
                  >
                    ...
                    <XAxis
                      dataKey="month"
                      tick={{ fontSize: 12, fill: C.med }}
                      axisLine={false}
                      tickLine={false}
                    />
                    <YAxis
                      tick={{ fontSize: 11, fill: C.med }}
                      axisLine={false}
                      tickLine={false}
          ...
          <div>
            ...
            >
              <div>
                ...
                <p style={{ color: C.med, fontSize: 13, margin: "3px 0 0" }}>
                  {t.invSub}
                </p>
              </div>
            ...
            >
              {[
                [t.totalProducts, products.length, C.primary],
                [t.totalStockUnits, totalStock, C.purple],
                [t.lowStockItems, lowStock.length, C.danger],
              ].map(([l, v, c]) => (
                <div key={l} style={metCard(c)}>
                  ...
                  <div style={{ fontSize: 26, fontWeight: 800, color: C.dark }}>
                    {v}
                  </div>
                </div>
              ))}
            ...
            {showForm && (
              <div style={{ ...glassCard, padding: 24, marginBottom: 20 }}>
                ...
                >
                  {[
                    [t.productName, "name", "text", "e.g. Silk Bangles"],
                        ...
                        >
                          ...
                          {(newP.category === "jewelry"
                            ...
                            : newP.category === "crafts"
                              ? CATS.crafts.subs
                              : newP.clothingGroup
                                ? CATS.clothing.groups[newP.clothingGroup]
                                : []
                          ).map((s) => (
                  ...
                  <div style={{ gridColumn: "span 2" }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 10, fontWeight: 400 }}>
                        (type & press Enter — e.g. S, M, L, XL, Free Size)
                      </span>
                    </label>
                    <TagInput
                      values={newP.sizes || []}
                  ...
                  <div style={{ gridColumn: "span 2" }}>
                    ...
                    >
                      🎨 Colors{" "}
                      <span style={{ fontSize: 10, fontWeight: 400 }}>
                        (type & press Enter — e.g. Red, Blue, Gold)
                      </span>
                    </label>
                    <TagInput
                      values={newP.colors || []}
                  ...
                  <div style={{ gridColumn: "span 2" }}>
                    ...
                    >
                      📦 Pack Size{" "}
                      <span style={{ fontSize: 10, fontWeight: 400 }}>
                        (type & press Enter — e.g. 1pc, 2pc, Set of 5)
                      </span>
                    </label>
                    <TagInput
                      values={newP.pieceCounts || []}
                      onChange={(v) =>
                        setNewP((p) => ({ ...p, pieceCounts: v }))
                      }
                      placeholder="1pc, 2pc, Set of 3..."
                    />
                  </div>
                  <div style={{ gridColumn: "span 2" }}>
                    <label
                    ...
                    <div
                      style={{ fontSize: 11, color: C.med, marginBottom: 8 }}
                    >
                      📌 Upload to{" "}
                      <b>
                        <a
                      ...
                      → BBCode → copy URL between [img]...[/img] → paste below.
                      Add up to 5 photos!
                    </div>
                ...
                <button style={{ ...btn, marginTop: 16 }} onClick={addProduct}>
                  {t.saveDb}
                </button>
              </div>
            )}
                    ...
                    >
                      <td style={TD}>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 11, color: C.med }}>
                              {(p.desc || "").slice(0, 40)}
                              {(p.desc || "").length > 40 ? "…" : ""}
                            </div>
                          </div>
                      ...
                      <td style={TD}>
                        ...
                        >
                          ...
                          {p.subcategory && (
                            <span style={{ fontSize: 10, color: C.med }}>
                      ...
                      <td style={{ ...TD, fontWeight: 700, color: C.primary }}>
                        ৳{p.price.toLocaleString()}
                      </td>
                      <td
                        style={{
                          ...
                          fontWeight: 800,
                          fontSize: 16,
                          color: p.stock <= 5 ? C.danger : C.dark,
                        }}
                      >
                        {p.stock}
                      </td>
        ...
        {tab === "orders" && isAdmin && (
          <div>
            ...
            <p style={{ color: C.med, fontSize: 13, marginBottom: 22 }}>
            ...
            >
              {[
                ["paid", t.paid, C.success, "rgba(232,245,233,0.75)"],
                ["processing", t.processing, C.warn, "rgba(255,243,224,0.75)"],
                ["shipped", t.shipped, C.info, "rgba(227,242,253,0.75)"],
                [
                  "pending_payment",
                  t.pendingPay,
                  C.danger,
                ...
                <tbody>
                  ...
                  {orders.map((o) => (
                    ...
                    >
                      ...
                      <td style={{ ...TD, fontSize: 12, color: C.med }}>
                        {o.customer?.phone || "—"}
                      </td>
                      <td style={{ ...TD, color: C.med, fontSize: 12 }}>
                        {(o.items || [])
            ...
            >
              <span style={{ color: C.med, fontSize: 14 }}>
                {t.totalRevAll}
              </span>
              <span
                style={{
          ...
          >
            ...
            <div style={{ padding: "22px 28px 28px" }}>
                    ...
                    {selectedProduct.pieceCounts.map((pc) => (
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 600,
                          fontFamily: "inherit",
                          border: `1.5px solid ${selPiece === pc ? "#AD1457" : "rgba(173,20,87,0.25)"}`,
                          background:
                            selPiece === pc
                              ? "rgba(173,20,87,0.1)"
                    ...
                    {selectedProduct.sizes.map((sz) => (
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 600,
                          fontFamily: "inherit",
                          border: `1.5px solid ${selSize === sz ? "#AD1457" : "rgba(173,20,87,0.25)"}`,
                          background:
                            selSize === sz
                              ? "rgba(173,20,87,0.1)"
                              : "rgba(255,255,255,0.6)",
              ...
              {selectedProduct.colors?.length > 0 && (
                <div style={{ marginBottom: 16 }}>
                  ...
                  >
                    🎨 Color{" "}
                    {selColor && (
                      <span style={{ fontWeight: 400, color: C.med }}>
                        — {selColor}
                      </span>
                    )}
                  </div>
                      ...
                      return hex ? (
                        <button
                          ...
                          style={{
                            ...
                            boxShadow:
                              selColor === cl
                                ? "0 0 0 2px #AD1457,0 2px 8px rgba(0,0,0,0.2)"
                        ...
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 600,
                            fontFamily: "inherit",
                            border: `1.5px solid ${selColor === cl ? "#AD1457" : "rgba(173,20,87,0.25)"}`,
                            background:
                              selColor === cl
                                ? "rgba(173,20,87,0.1)"
                                : "rgba(255,255,255,0.6)",
              ...
              >
                <div>
                  <div
                    style={{ fontSize: 11, color: C.light, marginBottom: 2 }}
                  >
                    মূল্য / Price
                  </div>
                  <div
            ...
            <div style={{ padding: 24 }}>
              ...
              >
                  ...
                  <>
                    ...
                    <div>
                      ...
                      >
                        ...
                        {(editProduct.clothingGroup
                          ? CATS.clothing.groups[editProduct.clothingGroup]
                          : []
                        ).map((s) => (
                          <option key={s} value={s}>
                            {s}
                ...
                <div style={{ gridColumn: "span 2" }}>
                  ...
                  <TagInput
                    values={editProduct.pieceCounts || []}
                    onChange={(v) =>
                      setEditProduct((p) => ({ ...p, pieceCounts: v }))
                    }
                    placeholder="1pc, 2pc, Set of 3..."
                  />
                </div>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color: authTab === k ? C.primary : C.med,
                    borderBottom:
                      authTab === k
                        ? `2px solid ${C.primary}`
        ...
        <>
          ...
          <div
            style={{
              ...
              boxShadow: "-8px 0 40px rgba(173,20,87,0.2)",
            }}
          >
            <div
              style={{
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {(item.size || item.color || item.piece) && (
                          <div
                            style={{ fontSize: 10, color: C.med, marginTop: 1 }}
                          >
                            {[item.size, item.color, item.piece]
                              .filter(Boolean)
                              .join(" · ")}
                      ...
                      <div
                        style={{ fontSize: 13, fontWeight: 800, color: C.dark }}
                      >
      ...
      {checkoutModal && (
        <>
          ...
          >
            ...
            <div style={{ padding: 24 }}>
              {[
                [t.fullName, "name", "text", "Your name"],
                [t.phoneNum, "phone", "tel", "01711-000000"],
                [t.email, "email", "email", "your@email.com"],
                [t.address, "address", "text", "House, Road, City"],
              ].map(([l, k, tp, ph]) => (
                <div key={k} style={{ marginBottom: 12 }}>
                  <label
                    style={{ fontSize: 12, color: C.med, fontWeight: 700 }}
                  >
                    {l}
                  </label>
                  <input
              ...
              >
                {payLoading
                  ? t.redirecting
                  : `৳${cartTotal.toLocaleString()} — ${t.payNow}`}
              </button>
              <div
                style={{
                  fontSize: 11,
