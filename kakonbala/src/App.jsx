...
export default function App() {
          ...
          try {
            ...
            if (snap.exists()) {
              ...
              setCustomer((c) => ({
                ...
                area: d.area || c.area,
                thana: d.thana || c.thana,
                postOffice: d.postOffice || c.postOffice,
                houseRoad: d.houseRoad || c.houseRoad,
                city: d.district || c.city,
              }));
            }
          } catch (e) {
  ...
  const heroSlides = [
    {
      ...
      sub: "Tells a Story",
      tagline: "🌸 Handmade with Love — কাঁকনবালা",
      btn1: "Shop Now",
      btn2: "Collections",
      cat: "all",
    },
    {
      bg: jewelryImg
        ? "url('" + jewelryImg + "')"
        : "linear-gradient(135deg,#880E4F,#AD1457,#E91E63)",
      headline: "Handcrafted Jewelry",
      sub: "for Every Occasion",
      tagline: "💍 Bangles · Rings · Earrings · Necklace",
      btn1: "Shop Jewelry",
      btn2: "View All",
      cat: "jewelry",
    },
    {
      ...
      tagline: "🏺 Mandala · Canvas Paint · Clay Art",
      btn1: "Shop Crafts",
      btn2: "View All",
      cat: "crafts",
    },
    {
      bg: clothingImg
        ? "url('" + clothingImg + "')"
        : "linear-gradient(135deg,#B71C1C,#E53935,#EF9A9A)",
      headline: "Elegant Clothing",
      sub: "Tradition Meets Style",
      tagline: "👗 Saree · Tops · Panjabi · Fotua",
      btn1: "Shop Clothing",
      btn2: "View All",
      cat: "clothing",
    },
  ...
  async function addProduct() {
    ...
    await addDoc(collection(db, "products"), {
      ...
      packOptions: newP.packOptions || [], // ← ADDED
      colorImages: newP.colorImages || {}, // ← ADDED
    });
    setNewP({
      name: "",
      category: "jewelry",
            ...
            <div>
              <div style={{ fontSize: 12, color: MED, marginBottom: 8 }}>
                ...
                >
                  ...
                  <div>
                    <div
                      style={{ fontSize: 12, fontWeight: 700, color: PRIMARY }}
                    >
                      {isAdmin ? "👑 Admin" : user.email.split("@")[0]}
                    </div>
                    <div style={{ fontSize: 10, color: LIGHT }}>My Account</div>
                  </div>
                </button>
              </div>
              <button
            ...
            <div style={{ marginBottom: 0, position: "relative" }}>
              ...
              <div
                style={{
                  ...
                  borderBottom: "none",
                  boxShadow: "0 -2px 20px rgba(173,20,87,0.06)",
                }}
              >
                <div
                  style={{
                  ...
                  >
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(90deg,rgba(45,10,63,0.72) 0%,rgba(45,10,63,0.3) 55%,transparent 100%)",
                      }}
                    />
                    <div
                      style={{
                ...
                {[
                  {
                    ...
                    loc: "Dhaka",
                    stars: 5,
                    text: "The bangles are absolutely gorgeous! Packaging was beautiful and delivery was super fast. Will definitely order again! 🌸",
                  },
                  {
                    name: "Rabeya K.",
                    loc: "Chittagong",
                    stars: 5,
                    text: "I ordered the mandala artwork and it exceeded my expectations. Truly handmade with so much detail and care. Highly recommended!",
                  },
                  {
                    name: "Sadia M.",
                    loc: "Sylhet",
                    stars: 5,
                    text: "Got the saree for my cousin's wedding — everyone loved it! The quality is amazing for the price. কাঁকনবালা rocks! ❤️",
                  },
                ].map((r, i) => (
                      ...
                      {[
                        ...
                        <button
                          ...
                          style={{
                            ...
                            background:
                              selectedGateway === name ? color + "12" : "#FFF",
                            display: "flex",
                            flexDirection: "column",
                            alignItems: "center",
                            gap: 4,
          ...
          >
            ...
            <div style={{ padding: 24 }}>
              ...
              >
                ...
                {orders.filter(
                  (o) =>
                    o.customer?.phone === profileData.phone ||
                    o.customer?.email === profileData.email,
                ).length === 0 ? (
                  <div
                    style={{
                      fontSize: 13,
